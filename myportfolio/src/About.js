...
function About() {
    return (
        <div>
            ...
            <h5>Goals</h5>
            <p>
                I'm currently seeking employment in a position that leverages my combined project management and software engineering skills. 
                I want to join an organization that values collaboration, a growth mindset, and making lives better.  My goal in the 
                future is to contribute my skills to greater social good. 
            </p>
        </div>
    )
}
